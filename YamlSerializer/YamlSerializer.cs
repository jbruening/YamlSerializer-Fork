...
{                   
    ...
    public class YamlSerializer
    {
        ...
        /// <summary>
        /// Deserialize the first yaml document, with the specified type as the root node
        /// </summary>
        /// <typeparam name="TType"></typeparam>
        /// <param name="yaml"></param>
        /// <returns></returns>
        public TType Deserialize<TType>(string yaml) where TType : class
        {
            var result = Deserialize(yaml, new Type[] {typeof (TType)});
            if( result.Length > 0 && result[0] is TType)
                return result[0] as TType;
